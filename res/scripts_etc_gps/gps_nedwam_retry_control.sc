...
if (-e $PRESENTDATE) then
   ...
   if (-e flag_file) then
      ...
      cp $ENV_TSA_GLOBAL/NEWH_TSA_$dtgw4"00_XX000_TW" $ENV_GPS_LOCAL/input_nedwam  
      ...
      #
      cd $ENV_GPS_LOCAL/input_nedwam
      if (-z NEWH_TSA_$dtgw4"00_XX000_TW" || !(-e NEWH_TSA_$dtgw4"00_XX000_TW")) then
         ...
         cd $ENV_GPS_LOG
         echo `date` >>& log.txt
         echo NEWH_TSA_$dtgw4"00_XX000_TW empty or not present" >>& log.txt
         echo "************************************************************************************" >>& log.txt
         ...
         # 
         cp NEWH_TSA_$dtgw4"00_XX000_TW" TSF_IN
