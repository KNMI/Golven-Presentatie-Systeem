...
if (-e $PRESENTDATE) then
   ...
   if (-e flag_file) then
      ...
      # dus niets te up-daten, alleen flag verwijderen 
      cd $ENV_GPS_LOCAL
      rm -f flag_file
      ...
      #
      # 6 uur geleden (dit script wordt b.v. te 12.50 aangeroepen om op de 06.00 UTC run file te werken)
      #
      ...
      if (!(-z NEWH_TSA_$dtgw6"00_XX000_TW") && -e NEWH_TSA_$dtgw6"00_XX000_TW") then
         ...
         # 
         cp NEWH_TSA_$dtgw6"00_XX000_TW" TSF_IN
